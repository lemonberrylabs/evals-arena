            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mt-8 bg-white p-6 rounded-lg shadow">
                    ...
                    <div className="prose prose-sm max-w-none">
                        <p>
                            LLM Evals Arena is an open-source tool for evaluating and comparing different language models.
                            You can use it to:
                        </p>
                        ...
                        <p>
                            ...
                            All communication happens directly between your browser and the LLM provider APIs.
                        </p>
