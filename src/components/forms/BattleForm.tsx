...
const battleFormSchema = z.object({
  ...
  selectedModels: z
    .array(z.string())
    .min(2, "Select at least 2 models to compare"),
});
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  This is the prompt that will be sent to all models in the
                  battle. Be clear and specific.
                </p>
                <textarea
          ...
          {activeTab === "developer" && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  This is the system message / instructions that will be given
                  to the models before the user prompt.
                </p>
                <textarea
          ...
          {activeTab === "judge" && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Define how the judge should evaluate the responses. Be
                  specific about what makes a good response.
                </p>
                <textarea
                  className={`w-full h-64 px-3 py-2 border rounded-md ${
