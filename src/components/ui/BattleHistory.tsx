    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button variant="outline" size="sm" onClick={handleClearHistory} className="text-red-600 hover:bg-red-50">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Models</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredBattles.map((battle) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-gray-800">{truncateText(battle.battleSetup.userPrompt, 80)}</td>
                ...
                <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                  <Button variant="ghost" size="sm" onClick={() => onSelectBattle(battle)}>
      ...
      {filteredBattles.length === 0 && searchTerm && (
        <div className="text-center py-4 text-gray-500">No battles found matching &quot;{searchTerm}&quot;</div>
      )}
    </div>
  )
}
