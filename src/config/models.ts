...
const availableModels: Model[] = [
  ...
  },
  {
    ...
    provider: Provider.OPENAI,
    description:
      "Optimized version of GPT-4 with improved performance and lower latency.",
  ...
  // Anthropic Models
  {
    ...
    description:
      "Anthropic's most powerful model with advanced reasoning and comprehension.",
  ...
  },
  {
    ...
    provider: Provider.ANTHROPIC,
    description:
      "A balanced model offering strong performance with lower latency.",
    capabilities: ["text generation", "reasoning", "coding"],
    enabled: true,
  },
